...
describe('Реєстрація як ФОП', () => {
  it('positive', () => {
    ...
    //phone
    cy.get(':nth-child(3) > :nth-child(5) > .mat-form-field > .mat-form-field-wrapper > .mat-form-field-flex > .mat-form-field-infix')
    ...
    cy.get(':nth-child(4) > :nth-child(2) > .mat-form-field > .mat-form-field-wrapper > .mat-form-field-flex > .mat-form-field-infix')
      .type(user_data.EDRPOU)  

    //checkboxes
    cy.get('#mat-checkbox-3 > .mat-checkbox-layout > .mat-checkbox-inner-container')
